                ...
                <div class="wrap-top-bar">
                    ...
                    <div class="top-logo">
                        <a href="#" class="site-logo">
                            <img alt="" src="<?=$baseUrl?>/images/logo/logo.png">
                        </a>
                    </div>
                        ...
                        <div class="header-left">
                            <div class="header-logo-2">
                                <a href="<?=$baseUrl;?>" class="site-logo">
                                    <img id="logo_header" alt="" src="<?=$baseUrl?>/images/logo/logo.png"
                                        data-retina="<?=$baseUrl?>/images/logo/logo.png">
                                </a>
                            </div>
                            <nav class="main-menu mx-0">
                                <ul class="navigation">
                                    <li class=" relative current-menu-item">
