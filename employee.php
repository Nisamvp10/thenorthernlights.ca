<?php include('inc/headerLinks.php');?>
            ...
            <div class="page-title">
             ...
             <div class="main-content-2 ">
                            ...
                            <div class="row ">
                                <div class="col-md-5">
                                    <div class="image-wrap  wow fadeInLeft effec-overlay" data-wow-duration="1000" data-wow-delay="0s">
                                        <img class="lazyload" data-src="images/emp.png" src="images/emp.png" alt="">
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <div class="box-about">
                                        ...
                                        <div class="heading-section text-start  wow fadeInUp" data-wow-duration="1000" data-wow-delay="0s">
                                            ...
                                            <h3>Assist Your Staff in Getting Addiction and Mental Health Treatment

                                            </h3>
                                            <p class="description text-1 lh-30 wow fadeInUp" data-wow-duration="1000" data-wow-delay="0s">With a team of
                                                Did you know that poor mental health causes five lakh Canadians to miss work each week? Employee morale and productivity may suffer when they experience addiction, depression, or trauma. These repercussions can occasionally be fatal. There might be a limit to how far your staff can advance without medical assistance, even if you've tried everything. Additionally, people occasionally require an immersive, distraction-free setting in order to make significant progress, particularly if they deal with triggers at work.
                ...
                <section class="section-contact home-page-2 bg-1  tf-spacing-1 ">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12">
...
The treatment facilities at Northern Lights have over a century of combined experience assisting individuals in recovering from addiction and mental disorders. We encourage businesses to contact us through our corporate partner program in order to assist employees who are in need.

In addition to enhancing the lives of their workers, our corporate partners save money by rehabilitating staff members rather than recruiting and onboarding new ones.

In addition to treating addiction, we are well-known for our treatment programs for first responders, veterans, and members of the armed forces. From coast to coast, we provide inpatient and outpatient facilities as well as online treatment programs to make care accessible. In order to help your employees maintain their progress when they return to work, we also provide aftercare and family support. 
                                    ...
                                    <div class="widget-content-tab">
                                        <div class="widget-content-inner active">
                                            <div class="box-service">
                                                <div class="image-wrap wow fadeInLeft effec-overlay" data-wow-duration="1000" data-wow-delay="0s">
                                                    <img class="lazyload" data-src="images/section/tnl.jpg"
                                                        src="images/section/tnl.jpg" alt="">
                                                </div>
                                                <div class="content">
                                                    <div class="heading-section text-start ">
                                                        <p class="text-2 sub wow fadeInUp" data-wow-duration="1000" data-wow-delay="0s">corporate Partner</p>
                                                        <h4 class="wow fadeInUp" data-wow-duration="1000" data-wow-delay="0s"><a
                                                                href="#">Employees Access Addiction.</a></h4>
                                                        <p class="description text-1 lh-30 wow fadeInUp" data-wow-duration="1000" data-wow-delay="0s">Access to addiction and mental health treatment for employees is a critical aspect of workplace wellness programs. Employers play a significant role in facilitating access to such services, which can enhance employee productivity and overall organizational health. Effective programs often include confidential support services, resources for recovery, and awareness initiatives to reduce stigma surrounding mental health issues. Providing these services not only benefits employees but can also lead to improved morale, reduced absenteeism, and greater workplace cohesion.
                                                        </p>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 ">
                                <div class="heading-section">
                                    <p class="text-2 sub wow fadeInUp" data-wow-duration="1000" data-wow-delay="0s">Benefits
                                    </p>
                                    <h3 class="wow fadeInUp" data-wow-duration="1000" data-wow-delay="0s">Why We Works
                                    </h3>
