     <?php include('inc/headerLinks.php');?>
            ...
            <div class="page-title">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="title"> Bipolar Disorder
                            </h3>
                            ...
                            <div class="col-lg-8">
                                <div class="content-inner">
                                    <div class="image-wrap">
                                        <img class="lazyload" data-src="images/section/Bipolar_Disorder.jpg"
                                            src="images/section/Bipolar_Disorder.jpg" alt="">
                                    </div>
                                    <div class="heading">
                                        <h4 class="mb-16">Our Approach to Depression, Bipolar Disorder, and Anxiety Treatment</h4>
                                    ...
                                    <div class="benefits">
                                        <div class="heading">
                                            <h4 class="mb-16">What Are Anxiety Disorders?</h4>
                                            <p class="text-1 lh-30">
